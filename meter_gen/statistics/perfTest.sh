...
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 100 -endDate '2016/01/08' -out './perfTest/07d-100u.csv'

echo
echo '1 Month, 1/30min, 100 users, mixed' # 148.800 data, ~7Mo
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 100 -endDate '2016/02/01' -out './perfTest/31d-100u.csv'

echo
echo '1 Year, 1/30min, 100 users, mixed' # 1.752.000 data
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 100 -endDate '2017/01/01' -out './perfTest/12m-100u.csv'
rm './perfTest/12m-100u.csv' &


echo
echo '1 Day, 1/30min, 1000 users, mixed' # 480.000 data, ~60Mo
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 1000 -endDate '2016/01/02' -out './perfTest/01d-01ku.csv'

echo
echo '1 Week, 1/30min, 1000 users, mixed' # 336.000 data, ~200Mo
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 1000 -endDate '2016/01/08' -out './perfTest/07d-01ku.csv'

echo
echo '1 Month, 1/30min, 1000 users, mixed' # 1.488.000 data, ~200Mo
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 1000 -endDate '2016/02/01' -out './perfTest/31d-01ku.csv'
rm './perfTest/31d-01ku.csv' &

echo
echo '1 Year, 1/30min, 1000 users, mixed' # 17.520.000 data
node ../meter_gen.js -config './perfTestConf.json' -metersNumber 1000 -endDate '2017/01/01' -out './perfTest/12m-01ku.csv'
