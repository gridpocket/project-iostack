...
$1 -temp -out './out-go/temp.csv'

echo '\nTEST LOCATION'
# Generating 100 meters, with data for 5 monthes, one data by meter each 60minutes, all meters from random heated houses, printing city name, region number and meter location
$1 -location -out './out-go/location.csv'
...
$1 -lastID 10 -out './out-go/lastID.csv'
...
$1 -startID 90 -out './out-go/startID.csv'
...
$1 -startID 45 -lastID 55 -out './out-go/start&last.csv'
...
$1 -out './out-go/sepFilesDay/%y-%M-%D_%h-%m.csv'
...
$1 -out './out-go/sepFilesMonth/%Y/%M.csv'
...
$1 -startID 45 -lastID 55 -location -temp -out './out-go/sepFiles_start_last/%Y-%M.csv'
...
$1 -maxFileSize 1M -out './out-go/maxFileSize10k/%N.csv'
...
$1 -maxFileSize 1M -startID 45 -lastID 55 -location -temp -out './out-go/maxFileSize_start_last/%N.csv'
...
$1 -maxFileSize 100k -out './out-go/sepFiles_maxFileSize/%Y-%M_%N.csv'