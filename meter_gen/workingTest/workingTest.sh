...
node ../meter_gen.js -config "./workingTest/config.json" -meterTypes "electric" -out './out/out-elec.csv'

echo '\nTEST GAS'
# Generating 100 meters, with data for 5 monthes, one data by meter each 60minutes, all meters from gas heater houses
node ../meter_gen.js  -config "./workingTest/config.json" -meterTypes "gas" -out './out/out-gas.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -out './out/out-mixed.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -location -out './out/location.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -lastID 10 -out './out/lastID.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -startID 90 -out './out/startID.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -startID 45 -lastID 55 -out './out/temp.csv'
...
node ../meter_gen.js -config "./workingTest/config.json" -separateDataBy 0 -out './out/sepFiles0/'
...
node ../meter_gen.js -config "./workingTest/config.json" -separateDataBy 1 -out './out/sepFilesNoArg/'
...
node ../meter_gen.js -config "./workingTest/config.json" -separateDataBy 5 -out './out/sepFiles5/'
...
node ../meter_gen.js -config "./workingTest/config.json" -separateDataBy 0 -startID 45 -lastID 55 -location -temp -out './out/sepFiles_start_last/'
...
node ../meter_gen.js -config "./workingTest/config.json" -maxFileSize 1M -out './out/maxFileSize10k/'
...
node ../meter_gen.js -config "./workingTest/config.json" -maxFileSize 1M -startID 45 -lastID 55 -location -temp -out './out/maxFileSize_start_last/'
