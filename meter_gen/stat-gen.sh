...
#node meter_gen.js 1000 '2016/09/01' '2017/03/01' 90 electric -location -out './stat-gen/generatedColdElec.csv'
cat ./stat-gen/generatedColdElec.csv | egrep '^("2017/03/01"|[a-zA-Z])' > ./stat-gen/lightColdElec.csv

echo "Generating Hot Elec..."
#node meter_gen.js 1000 '2016/06/01' '2017/08/01' 90 electric -location -out './stat-gen/generatedHotElec.csv'
cat ./stat-gen/generatedHotElec.csv | egrep '^("2017/06/01"|[a-zA-Z])' > ./stat-gen/lightHotElec.csv
