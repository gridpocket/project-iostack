...
var fs = require('fs');
var locations = require('./citytest.json');
...
//Generate CSV file
fs.appendFileSync(FILENAME, "date,index,sumHC,sumHP,vid,city,lat,long,density,size\n");
        ...
        if ((d.format('MM')<'11') && (d.format('MM')>'03')) { // Hot season (March -> November)
            if ((d.format('dddd') != "Sunday")&&(d.format('dddd') != "Saturday")) { // Working day (MTWTF)
                if ( (d.format('HH:mm')<='06:00') && (d.format('HH:mm')>='00:00') ) { // Night
                    if (meter.houseType == "20"){
                        meters[i].conso = rand.rnorm(1316, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso = rand.rnorm(2471, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso = rand.rnorm(3611, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso = rand.rnorm(4635, 30)/(60/MINUTES_INTERVAL);
                    }
                }
                if ( (d.format('HH:mm')<'09:00') && (d.format('HH:mm')>'06:00') ) {
                    if (meter.houseType == "20"){
                        meter.conso= rand.rnorm(4605, 80)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "50"){
                        meter.conso= rand.rnorm(8647, 80)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "70"){
                        meter.conso= rand.rnorm(12637, 80)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "100"){
                        meter.conso= rand.rnorm(16222, 80)/(60/MINUTES_INTERVAL); 
                    }
                }
                if ( (d.format('HH:mm')<='17:00') && (d.format('HH:mm')>='09:00') ) {
                    if (meter.houseType == "20"){
                        meter.conso = rand.rnorm(1316, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meter.conso = rand.rnorm(2471, 30)/(60/MINUTES_INTERVAL);  
                    }
                    else if (meter.houseType == "70"){
                        meter.conso = rand.rnorm(3611, 30)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "100"){
                        meter.conso = rand.rnorm(4635, 30)/(60/MINUTES_INTERVAL); 
                    }
                }
                if ( d.format('HH:mm')>'17:00' ) {
                    if (meter.houseType == "20"){
                        meter.conso = rand.rnorm(5263, 100)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "50"){
                        meter.conso = rand.rnorm(9882, 100)/(60/MINUTES_INTERVAL);  
                    }
                    else if (meter.houseType == "70"){
                        meter.conso = rand.rnorm(14442, 100)/(60/MINUTES_INTERVAL); 
                    }
                    else if (meter.houseType == "100"){
                        meter.conso = rand.rnorm(18539, 100)/(60/MINUTES_INTERVAL);    
                    }
                }
                ...
                if ( (d.format('HH:mm')<'09:00') && (d.format('HH:mm')>'07:00') ) {
                    if(meter.houseType == "20"){
                        meters[i].conso= rand.rnorm(4605, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso= rand.rnorm(8647, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso= rand.rnorm(12637, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso= rand.rnorm(16222, 80)/(60/MINUTES_INTERVAL);
                    }
            ...
            if ((d.format('dddd') != "Sunday")&&(d.format('dddd') != "Saturday")) { // Working day
                ...
                if ( (d.format('HH:mm')<='06:00') && (d.format('HH:mm')>='00:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso = rand.rnorm(714, 50)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso = rand.rnorm(1341,50)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso = rand.rnorm(1960,50)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso = rand.rnorm(2516,50)/(60/MINUTES_INTERVAL);
                    }
                }//between 6h and 9h
                if ( (d.format('HH:mm')<'09:00') && (d.format('HH:mm')>'06:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso= rand.rnorm(833, 70)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso= rand.rnorm(1565, 70)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso= rand.rnorm(2287, 70)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso= rand.rnorm(2935, 70)/(60/MINUTES_INTERVAL);
                    }
                }//between 9h and 17h
                if ( (d.format('HH:mm')<='17:00') && (d.format('HH:mm')>='09:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso= rand.rnorm(476, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso= rand.rnorm(894, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso = rand.rnorm(1307, 30)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso = rand.rnorm(1677, 30)/(60/MINUTES_INTERVAL);
                    }
                }//plus de 17h
                if ( d.format('HH:mm')>'17:00' ){
                    if (meter.houseType == "20"){
                        meters[i].conso = rand.rnorm(1310, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso = rand.rnorm(2459, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso = rand.rnorm(3593, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso = rand.rnorm(4613, 100)/(60/MINUTES_INTERVAL);
                    }
                ...
                if ( (d.format('HH:mm')<='07:00') && (d.format('HH:mm')>='00:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso = rand.rnorm(714, 20)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso = rand.rnorm(1341, 20)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso = rand.rnorm(1960, 20)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso = rand.rnorm(2516, 20)/(60/MINUTES_INTERVAL);
                    }
                } //
                else if ( (d.format('HH:mm')<'09:00') && (d.format('HH:mm')>'07:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso= rand.rnorm(952, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso= rand.rnorm(1788, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso= rand.rnorm(2613, 80)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso= rand.rnorm(3355, 80)/(60/MINUTES_INTERVAL);
                    }
                }
                else if ( (d.format('HH:mm')<='17:00') && (d.format('HH:mm')>='09:00') ) {
                    if (meter.houseType == "20"){
                        meters[i].conso= rand.rnorm(1071, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "50"){
                        meters[i].conso= rand.rnorm(2012, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "70"){
                        meters[i].conso= rand.rnorm(2940, 100)/(60/MINUTES_INTERVAL);
                    }
                    else if (meter.houseType == "100"){
                        meters[i].conso= rand.rnorm(3774, 100)/(60/MINUTES_INTERVAL);
                    }
                }
